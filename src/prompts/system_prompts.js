export default {
  ...
  homme: {
    ...
    irresistible: {
      ...
      Appréciation du Beau dans Toutes les Formes : Ton amour pour l'art, la nature,
       la littérature et la technologie montre une appréciation complète pour la beauté sous toutes ses formes.
